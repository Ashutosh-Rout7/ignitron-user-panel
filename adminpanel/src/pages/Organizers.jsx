...
export default function Organizers() {
  ...
  const fetchRequests = async () => {
    try {
      ...
      console.error(err);
      toast.error("Failed to fetch organizer requests");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Review and approve students requesting organizer access.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="glass-card p-16 text-center">
          <div className="mx-auto mb-4 grid h-16 w-16 place-items-center rounded-2xl bg-orange-500/10">
            <Users className="h-8 w-8 text-orange-500" />
          </div>
          <h3 className="text-lg font-semibold">No pending requests</h3>
          <p className="mt-1 text-sm text-muted-foreground">
            No students have requested organizer access yet.
          </p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl bg-orange-500 px-4 py-2 text-sm font-semibold text-white hover:bg-orange-600 transition disabled:opacity-60"
                >
